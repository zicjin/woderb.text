 ...
 * @author hankcs
 */
public class NShortSegmentDemo
{
    public static void main(String[] args)
    {
        Segment nShortSegment = new com.hankcs.hanlp.seg.NShort.NShortSegment().enableCustomDictionary(false).enablePlaceRecognize(true).enableOrganizationRecognize(true);
