...
public class OccurrenceDemo
{
    ...
    {
        com.hankcs.hanlp.corpus.occurrence.Occurrence occurrence = new com.hankcs.hanlp.corpus.occurrence.Occurrence();
        occurrence.addAll("兰州银行在其官方微信宣布兰州银行ATM上线扫码取款业务，使用微信或支付宝扫ATM机上的二维码，即可将微信或支付宝内的余额提现。随着不带现金和银行卡出门的现象越来越普遍，兰州银行此举被认为是抓住了时下痛点，具有开创意义。");
        occurrence.compute();
